...
align-items는 부모의 자식을 가리킨다


text-align은 박스안에 있는 텍스트를 가리킨다 <br>


### 나만의 색상 저장하는 방법

 variavles.css 파일 생성후 
...
visited : 방문후 링크상태를 스타일 변화적용

active : 마우스 클릭할때 (누른상태) 스타일적용

hover : 마우스 오버했을때 스타일 변화

focus : 키보드 or 마우스로 포커스 받을때 스타일 적용

focus-whithin : focused자식을 둔 부모엘리먼트에 적용된다.
